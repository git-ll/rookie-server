...
namespace rookie
{
    ...
    public:
        ...
        void updateChannle(Channel* channel,bool timeout);    //修改Channel，如果本身不存在，就转为添加
